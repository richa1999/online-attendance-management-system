...
<head>
     ...
     <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"
          ...
          crossorigin="anonymous"></script>
     <link rel="stylesheet" href="<?php echo base_url() ?>assets/student/css/studentatt.css">
               ...
               <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="sidebar-sticky pt-3">
                         <ul class="nav flex-column">
                              <li class="nav-item">
                                   <a class="nav-link" href="<?php echo base_url("index.php/students/profile") ?>">
                              ...
                              <li class="nav-item">
                                   <a class="nav-link active" href="<?php echo base_url("index.php/students/student_portal") ?>">
                              ...
                              <li class="nav-item">
                                   <a class="nav-link" href="<?php echo base_url("index.php/students/notification") ?>">
                              ...
                              <li class="nav-item">
                                   <a class="nav-link" href="academic-calender.html">
